...
class Nav extends React.Component {
    ...
    render() {
        ...
        if (this.state.width > 1024 || this.state.expandHam) {
            links = (
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow text-teal-200 dark:text-white">
                        <a href="#"
                           className="block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4 nav-link">
                            Contact
                        </a>
                        <Link href={"https://twitter.com/eversedev"} prefetch={false}>
                            <a className="block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4 nav-link">
                                Twitter
                            </a>
                        </Link>
                        <Link href={"https://discord.gg/wBjy7Gb"} prefetch={false}>
                            <a className="block mt-4 lg:inline-block lg:mt-0 hover:text-white nav-link">
                                Discord
                            </a>
                        </Link>
                    </div>
        ...
        return (
            <nav className="flex items-center justify-between flex-wrap p-6 bg-brand dark:bg-gray-900 transition-colors ease-out duration-500">
                <div className="flex items-center flex-shrink-0 text-white mr-6 logo" onClick={() => Router.push('/')}>

                    <svg className="fill-current h-8 w-8 mr-2" xmlns="http://www.w3.org/2000/svg" width="512"

...
pg.schema.hasTable('accounts').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("accounts", table => {
      table.increments('id');
...
pg.schema.hasTable('applications_users').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("applications_users", table => {
...
pg.schema.hasTable('oauth_applications').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("oauth_applications", table => {
      table.bigIncrements('id');
...
pg.schema.hasTable('packages').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("packages", table => {
      table.bigIncrements('id');
...
pg.schema.hasTable('purchases').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("purchases", table => {
      table.bigIncrements('id');
...
pg.schema.hasTable('uploads').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("uploads", table => {
      table.bigIncrements("id");
...
pg.schema.hasTable('discounts').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("discounts", table => {
      table.bigIncrements('id');
...
pg.schema.hasTable('files').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("files", table => {
...
pg.schema.hasTable('devices').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("devices", table => {
...
pg.schema.hasTable('transactions').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("transactions", table => {
...
pg.schema.hasTable('inventories').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable('inventories', table => {
...
pg.schema.hasTable('sessions').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("sessions", table => {
...
pg.schema.hasTable('emails').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable('emails', table => {
...
pg.schema.hasTable('messages').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable('messages', table => {
...
pg.schema.hasTable('portfolio').then(hasTable => {
  console.log(hasTable)
  if (!hasTable) {
    return pg.schema.createTable("portfolio", table => {
      table.bigIncrements("portfolio_id");
    
      table.integer("developer_id", 11).unsigned();
    
      table.text("portfolio_endpoint");
      table.text("developer_display");
      table.text("developer_email");
      table.text("developer_icon");
